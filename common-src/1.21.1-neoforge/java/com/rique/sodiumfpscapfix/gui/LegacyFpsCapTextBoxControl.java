...
public final class LegacyFpsCapTextBoxControl implements Control<Integer> {
    private final Option<Integer> option;

    public LegacyFpsCapTextBoxControl(Option<Integer> option) {
        this.option = option;
    }
    ...
    private static final class TextBoxControlElement extends ControlElement<Integer> {
        ...
        public void render(GuiGraphics graphics, int mouseX, int mouseY, float delta) {
            ...
            this.drawString(graphics, this.option.getName(), this.dim.x(), this.getTextY(), this.option.isAvailable() ? 0xFFFFFFFF : 0xFFA0A0A0);
